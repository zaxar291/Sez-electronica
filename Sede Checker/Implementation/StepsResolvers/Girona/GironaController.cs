...
namespace Sede_Checker.Implementation.StepsResolvers.Girona
{
    class GironaController : IStepsController
    {
        ...
        public readonly IRecaptchaV2Resolver CaptchaResolver;
        ...
        public GironaController(SedeTaskData user,
        ...
        private bool DoFourthStep()
        {
            if (this.WebDriver.InvokeMemberClick($"#{GetDocumentTypeId(this.UserData.DocumentType)}") &&
                ...
                this.WebDriver.SelectElementInList("#txtParentesco", this.UserData.FamiliarConnectionWithCitizen))
            {
                this._logger.Info("OK! Second step solved successfully!");
        ...
        private bool DoSeventhStep()
        {
            if (this.WebDriver.ElementExists("#txtTelefonoCitado"))
            {
                if (this.WebDriver.UpdateFieldData("#txtTelefonoCitado", this.UserData.CustomerPhoneNumber) &&
                    ...
                    this.WebDriver.SelectElementInList("#txtPaisExtranjero", this.UserData.FamiliarNationality) &&
                    this.WebDriver.UpdateFieldData("#txtIdExtranjero", this.UserData.FamiliarDocumentNumber) &&
                    this.WebDriver.UpdateFieldData("#txtDesExtranjero", this.UserData.FamiliarNameAndSurname) &&
                    this.WebDriver.ExecuteScript(_scripts["DomButtonClickAction"], new object[] { "#btnSiguiente" }))
                {
                    return true;
                }
        ...
        private string GetDocumentTypeId(DocumentType type)
        {
            switch (type)
            {
                ...
                case DocumentType.INCIAL:
                    return "rdTipoSolicitudI";
                case DocumentType.RENOVACION:
                    return "rdTipoSolicitudR";
                default:
                    return String.Empty;
            }
        }
