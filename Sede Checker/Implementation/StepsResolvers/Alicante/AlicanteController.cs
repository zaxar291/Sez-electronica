...
namespace Sede_Checker.Implementation.StepsResolvers.Alicante
{
    class AlicanteController : IStepsController
    {
        ...
        public AlicanteController(SedeTaskData user, 
        ...
        {
            if (this.WebDriver.InvokeMemberClick("#cookie_action_close_header") &&
                this.WebDriver.ExecuteScript(_scripts["DomButtonClickAction"], new object[] { "#enviarCorreo" }) &&
