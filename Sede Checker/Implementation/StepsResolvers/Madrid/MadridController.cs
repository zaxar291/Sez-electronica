...
namespace Sede_Checker.Implementation.StepsResolvers.Madrid
{
    class MadridController : IStepsController
    {
        ...
        public const string ReagrupacionFamiliarprocedure = "REAGRUPACIÓN FAMILIAR";
        public const string PoliciaAutorizacionesDeRegreso = "POLICIA-AUTORIZACIONES DE REGRESO";
        public const string ResidenciaPorArragaio = "AUT. DE RESIDENCIA TEMPORAL POR CIRCUNS. EXCEPCIONALES POR ARRAIGO";
        public const string AsiloProcedure = "ASILO - OFICINA DE ASILO Y REFUGIO. Expedición/Renovación de Documentos. Calle Pradillo";
        public MadridController(SedeTaskData user, 
        ...
        private void FinishSteps(string solution)
        {
            ...
            this.CreateHtmlPage("tenth_page");
        ...
        {
            if (this.UserData.ProcedureName.Equals(ResidenciaPorArragaio) || this.UserData.ProcedureName.Equals(AsiloProcedure))
            {
        ...
        private bool DoSeventhStep()
        {
            ...
            {
                if (this.UserData.ProcedureName.Equals(ReagrupacionFamiliarprocedure))
                {
                    if (this.WebDriver.UpdateFieldData("#txtTelefonoCitado", this.UserData.CustomerPhoneNumber) && 
                        ...
                        this.WebDriver.UpdateFieldData("#familiares0txtDescripcion", "CARRIE RUTH ANDERSON") && 
                        this.WebDriver.SelectElementInList("#familiares0txtParentesco", "CONYUGE") &&
                        this.WebDriver.ExecuteScript(_scripts["DomButtonClickAction"], new object[] { "#btnSiguiente" }))
                    {
                        return true;
                    }
                    return false;
                }else if (this.UserData.ProcedureName.Equals(AsiloProcedure))
                {
                    if (this.WebDriver.UpdateFieldData("#txtTelefonoCitado", this.UserData.CustomerPhoneNumber) &&
                        this.WebDriver.UpdateFieldData("#emailUNO", this.UserData.CustomerEmail) &&
                        this.WebDriver.UpdateFieldData("#emailDOS", this.UserData.CustomerEmail) &&
        ...
        private bool DoEightStep()
        {
            if (this.WebDriver.ElementExists("$//*[@id='cita_1']/input"))
            {
                ...
                if (this.WebDriver.ExecuteScript(_scripts["DomButtonClickAction"], new object[] { "#btnSiguiente" }) &&
